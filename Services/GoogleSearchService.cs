...
public class GoogleSearchService
{
    ...
    public GoogleSearchService(HttpClient httpClient = null)
    {
    ...
    private Dictionary<string, string> GetQueryParams(string term, GoogleSearchOptions options)
    {
    ...
    private List<GoogleSearchResult> ParseResults(string html)
    {
